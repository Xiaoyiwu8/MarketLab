...
## 左侧 / 右侧合并推荐（retest-reversal-v2）

每日合计最多2只做多、2只做空，每只显示左侧/右侧及具体策略；同一方向同一股票仅占一个名额。右侧沿用下方突破回踩规则。左侧新增40日横盘后的低位假跌破收回（黄金坑形态候选），以及高位假突破收回后的压力反转做空，均要求后续独立日线确认而非仅凭低价或高价入选。横盘区间必须在此前120日范围的低35%或高35%；试探幅度不超过0.75 ATR，试探日或确认日量比至少1.2，以原区间中位价为第一目标，收益风险比至少2。
